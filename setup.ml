...
(* OASIS_START *)
(* DO NOT EDIT (digest: e86317961df600269cf3da1f1e20f220) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("ocamltter", None)];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "M\187\167\1939\253\223\182\n\003\239\161\173N\133\154";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
