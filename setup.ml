...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7e64a97793d1a3930b5808b962264054) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("twitter", None);
                           FindlibPackage ("meta_conv.syntax", None);
                           FindlibPackage ("ocaml_conv", None);
                   ...
                   {exec_custom = false; exec_main_is = "ninja.ml"; })
            ];
          plugins =
            [
               (`Extra, "META", Some "0.3");
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\181\209\186K\213\231\201\145%Li\200\2027\165\211";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
